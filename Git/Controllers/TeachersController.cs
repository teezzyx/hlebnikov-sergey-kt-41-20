    ...
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Teachers != null ? 
                          ...
                          Problem("Entity set 'Context.Teachers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,LastName,FirstMidName,EnrollmentDate")] Teachers teachers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,LastName,FirstMidName,EnrollmentDate")] Teachers teachers)
        {
            if (id != teachers.ID)
            {
                return NotFound();
